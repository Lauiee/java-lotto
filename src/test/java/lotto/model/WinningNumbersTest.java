...
class WinningNumbersTest {
    ...
    @Test
    void 당첨_번호_중복(){
        Assertions.assertThatThrownBy(() -> new WinningNumbers(List.of(1,2,3,4,4,5), 6))
    ...
    @Test
    void 당첨_번호_범위_벗어남(){
        Assertions.assertThatThrownBy(() -> new WinningNumbers(List.of(1,2,3,4,5,46), 6))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    @Test
    void 보너스_번호_중복(){
        Assertions.assertThatThrownBy(() -> new WinningNumbers(List.of(1,2,3,4,5,6), 6))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    @Test
    void 보너스_번호_범위_벗어남(){
        Assertions.assertThatThrownBy(() -> new WinningNumbers(List.of(1,2,3,4,5,6), 46))
                .isInstanceOf(IllegalArgumentException.class)
